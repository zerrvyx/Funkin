...
{
	public static var projectFnfVersion:String = '2.0 (ALPHA 2)';
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "ProjectFNF v" + projectFnfVersion + " (Psych Engine v" + psychEngineVersion + ")", 12);
